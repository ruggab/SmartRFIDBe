...
/**
 * The persistent class for the "vw_diff_giacenze" database table.
 * 
 */
@Entity
@Table(name="\"vw_diff_giacenze\"")
@NamedQuery(name="VwDiffGiacenze.findAll", query="SELECT v FROM VwDiffGiacenze v")
public class VwDiffGiacenze implements Serializable {
