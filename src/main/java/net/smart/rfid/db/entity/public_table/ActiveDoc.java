...
/**
 * The persistent class for the "active_docs" database table.
 * 
 */
@Entity
@Table(name="\"active_docs\"")
@NamedQuery(name="ActiveDoc.findAll", query="SELECT a FROM ActiveDoc a")
public class ActiveDoc implements Serializable {
